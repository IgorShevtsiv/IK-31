...
class TestClass(unittest.TestCase):
    def setUp(self):
        ...
        self.amtime = 'Some text AM Some text'
        self.pmtime = 'Some text PM Some text'
        self.badtime = 'No time'
    ...
    def test_home_work(self):
        self.assertTrue(home_work(self.amtime) == 'am')
        self.assertTrue(home_work(self.pmtime) == 'pm')
        self.assertTrue(home_work(self.badtime) == 'bad_time')
